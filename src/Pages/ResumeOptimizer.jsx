...
import { fadeInUp, staggerContainer } from '../utills/animations.jsx';
import { formatDate } from '../utills/formatters.js';
...
const ResumeBuilder = () => {
  ...
  const templates = [
    ...
    { id: 'minimal', name: 'Minimal', color: 'from-gray-500 to-gray-700', 
